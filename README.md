# Hydrogen Music re_alpha.2

Hydrogen Music re_alpha is a first-pass Android port scaffold for the Hydrogen desktop player.  
This repository is intentionally conservative: it focuses on **landscape tablet use**, **original-style UI placeholders**, **local audio playback**, and **touch-friendly UI** first.

## What this version is for

- Landscape / tablet-first interface
- My Music → Local Music folder picking and scanning (including sidecar .lrc lyric files)
...
- A global render-scale slider is available in Settings to reduce load on lower-resolution devices
...
### Working now
- Open the home dashboard with placeholder recommendation cards
- Enter My Music / Local Music without login
